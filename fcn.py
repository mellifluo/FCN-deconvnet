...
def FCN(input_shape=None):
    ...
    upscore = Conv2DTranspose(21,kernel_size=(64,64),strides=(32,32),use_bias=False)(score_fr)
    ...
    model = Model(inputs=inputData, outputs=[upscore])
    #model.load_weights('../keras-deconvnet/fcn.h5', by_name=True)
